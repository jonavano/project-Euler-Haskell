...
bigNums :: [Integer]
bigNums = [37107287533902102798797998220837590246510135740250,
  ...
  -- 5537376230 390876637302048746832985971773659831892672

------
-- problem 14: largest Collatz problem

-- collatz :: Num a -> [a]
-- collatz :: (Integral a, Fractional a) => a -> [a]
collatz 1 = [1]
collatz n | even n = n : collatz (n `div` 2)
collatz n = n : collatz (3 * n + 1)

collatzList = [length (collatz x) | x <- [1..999999]]

collatzListBaby :: [(Int,Int)]
collatzListBaby = [(x, length (collatz x)) | x <- [1..99]]
